...
// Initialization
Synch17Tree::Synch17Tree(TTree *tree, TString ch, bool isGGH) : fChain(0) {
  lock = false;
  ientry = -2;
...
void Synch17Tree::Init(TTree *tree, TString ch, bool isGGH){
  if(!tree) return;
...
// Read methods
void Synch17Tree::ReadInit(TTree *tree, TString ch)
{
...
//Write Methods
void Synch17Tree::WriteInit(TTree *tree, TString ch) {
  if (!tree) return;
