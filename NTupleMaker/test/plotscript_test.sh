PATH_TO_TUPLES="/nfs/dust/cms/user/cardinia/HtoTauTau/HiggsCP/DNN/CMSSW_10_2_16/src/HiggsCP/Inputs/test_v2/NTuples_mt_2017/"
#PATH_TO_TUPLES="/nfs/dust/cms/user/filatovo/HTT/CMSSW_10_2_16/src/HiggsCP/Inputs/v2_VBF_norm_commented/NTuples_mt_2017/"
PATH_FOR_OUTPUT="./Plots/"
...
root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("pt_2","p_{T,#tau}[GeV]",30,25.,85.,"%s","(mt_1<50)*","Events",-1,"%s","%s",2017,%s,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $USE_DEEPTAU $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
...
root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("mjj","m_{jj}[GeV]",50,0,250.,"%s","(mt_1<50)*","Events",-1,"%s","%s",2017,%s,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $USE_DEEPTAU $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("dijetpt","p_{T,jj}[GeV]",50,0.,250.,"%s","(mt_1<50)*","Events",-1,"%s","%s",2017,%s,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $USE_DEEPTAU $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
...
#root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("m_sv*(m_sv>0)+(m_sv<=0)","m_{#tau#tau}[GeV]",50,0.,250.,"%s","(mt_1<50)*","Events",-1,"%s","%s",2017,%s,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $USE_DEEPTAU $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
...
#root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("mt_fast*(mt_fast>0)-10*(mt_fast<=0)","mt_fast[GeV]",35,-10.,340.,"%s","(mt_1<50)*","Events",-1,"%s","%s",2017,%s,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $USE_DEEPTAU $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("mt_fast","mt_fast[GeV]",35,-10.,340.,"%s","(mt_1<50)*","Events",-1,"%s","%s",2017,%s,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $USE_DEEPTAU $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("pt_fast","pt_fast[GeV]",30,0.,300.,"%s","(mt_1<50)*","Events",-1,"%s","%s",2017,%s,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $USE_DEEPTAU $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
...
root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("phi_fast","phi_fast",40,-TMath::Pi().,TMath::Pi(),"%s","(mt_1<50)*","Events",-1,"%s","%s",2017,%s,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $USE_DEEPTAU $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
...
root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("puppimt_1","puppimt_1[GeV]",40,0.,200.,"%s","","Events",-1,"%s","%s",2017,%s,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $USE_DEEPTAU $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("puppimt_2","puppimt_2[GeV]",40,0.,200.,"%s","","Events",-1,"%s","%s",2017,%s,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $USE_DEEPTAU $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("puppimet","puppimet[GeV]",40,0.,200.,"%s","","Events",-1,"%s","%s",2017,%s,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $USE_DEEPTAU $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("puppimetphi","puppimetphi",30,-TMath::Pi(),TMath::Pi(),"%s","(mt_1<50)*","Events",-1,"%s","%s",2017,%s,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $USE_DEEPTAU $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
