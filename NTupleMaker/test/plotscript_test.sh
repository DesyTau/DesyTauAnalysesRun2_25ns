...
root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("bpt_1","p_{T,lead.bj}[GeV]",30,26.,146.,"%s","(mt_1<50)*","Events",-1,"%s","%s",2017,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("bpt_2","p_{T,trail.bj}[GeV]",30,26.,146.,"%s","(mt_1<50)*","Events",-1,"%s","%s",2017,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
...
### NEW ###
root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("IP_helix_x_1","IP_helix_x_1",30,-0.015,0.035,"%s","(mt_1<50)*","Events",-1,"%s","%s",2017,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("IP_helix_y_1","IP_helix_y_1",30,-0.015,0.035,"%s","(mt_1<50)*","Events",-1,"%s","%s",2017,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
root -l -b -q `printf 'Plot_lept_mutau_NNNTuples.C("IP_helix_z_1","IP_helix_z_1",30,-0.015,0.035,"%s","(mt_1<50)*","Events",-1,"%s","%s",2017,%s,false,false,%s,%s)' $WEIGHT $PATH_TO_TUPLES $PATH_FOR_OUTPUT $APPLY_FF $SHOW_SIGNAL $COMPARE_CP` 
