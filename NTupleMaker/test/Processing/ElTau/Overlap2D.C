...
void Overlap2D()
{
	...
	variables.push_back("met_MT_16");
	
	variables.push_back("met_MTsum_16");
	variables.push_back("met_MTtot_16");
	variables.push_back("met_DZeta_16");
	variables.push_back("met_MCTb_16");

	variables.push_back("DZeta_MTsum_16");
	variables.push_back("DZeta_MTtot_16");
	variables.push_back("DZeta_MCTb_16");

	variables.push_back("MTsum_MCTb_16");
	variables.push_back("MTtot_MCTb_16");
	variables.push_back("MTsum_MCTb_16");

	variables.push_back("MT2lester_DZeta_16");
	variables.push_back("MT2lester_met_16");
...
//	}
	...
	TH1D* eventCount = (TH1D*)first_source->Get("eltau/histWeightsH");
	//TH1D* eventCount = (TH1D*)first_source->Get("eltau/inputEventsH");
	//TH1D* hxsec = (TH1D*)first_source->Get("eltau/xsec");
		...
		if (obj->IsA ()->InheritsFrom ("TH2") ) {
			...
			string fname= nextsource->GetName();
				...
				TH1D* eventCountt ;
				  ...
				  if  ( std::string::npos == fname.find("TT_TuneCUETP8M1_13TeV-powheg-pythia8") || !NormTT) eventCountt = (TH1D*)nextsource->Get("eltau/histWeightsH");
				  if ( NormTT && std::string::npos != fname.find("TT_TuneCUETP8M1_13TeV-powheg-pythia8") ) eventCountt = (TH1D*)nextsource->Get("eltau/histTopPt");
