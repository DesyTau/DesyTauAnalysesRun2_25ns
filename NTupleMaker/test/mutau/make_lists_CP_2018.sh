...
ls $dirMC/DYJetsToLL_M-50/*root > $OUTDIR/DYJetsToLL_M-50
ls $dirMC/DY1JetsToLL_M-50/*root > $OUTDIR/DY1JetsToLL_M-50
ls $dirMC/DY2JetsToLL_M-50/*root > $OUTDIR/DY2JetsToLL_M-50
ls $dirMC/DY3JetsToLL_M-50/*root > $OUTDIR/DY3JetsToLL_M-50
ls $dirMC/DY4JetsToLL_M-50/*root > $OUTDIR/DY4JetsToLL_M-50 
ls $dirMC/DYJetsToLL_M-10to50/*root > $OUTDIR/DYJetsToLL_M-10to50
...
ls $dirDataSingleMuon/SingleMuon_Run2018A-17Sep2018-v2/*root > $OUTDIR/SingleMuon_Run2018A
