...
#  fnames.append('/store/mc/RunIISpring16MiniAODv2/SMS-TStauStau_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/PUSpring16Fast_80X_mcRun2_asymptotic_2016_miniAODv2_v0-v1/70000/004B6496-8C2C-E611-8E43-0025905A60AA.root')
  fnames.append('/nfs/dust/cms/user/alkaloge/ACD/NAFtools-RunOnProcessed/CMSSW_8_0_21/src/FastSim/Output_mAOD/files/FILEIN')
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("/nfs/dust/cms/user/alkaloge/TauAnalysis/new/new/StauAnalysis/New8025/CMSSW_8_0_25/src/DesyTauAnalyses/NTupleMaker/test/Skims/FILEOUT.root")
                                 )

process.output = cms.OutputModule("PoolOutputModule",
                                  fileName = cms.untracked.string('/nfs/dust/cms/user/alkaloge/TauAnalysis/new/new/StauAnalysis/New8025/CMSSW_8_0_25/src/DesyTauAnalyses/NTupleMaker/test/Skims/output_particles_MC_FILEOUT.root'),
