...
ls $dirMC/TTTo2L2Nu_TuneCP5_PSweights_13TeV-powheg-pythia8/*root > $OUTDIR/TTTo2L2Nu_PSweights
ls $dirMC/TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8/*root > $OUTDIR/TTToSemiLeptonic_PSweights
...
ls $dirEmbedded/EmbeddingRun2017B_ElMu/*root > $OUTDIR/EmbeddedElMu_Run2017C
ls $dirEmbedded/EmbeddingRun2017B_ElMu/*root > $OUTDIR/EmbeddedElMu_Run2017D
