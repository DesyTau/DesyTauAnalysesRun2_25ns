...
#    fnames.append('/store/mc/RunIISpring15MiniAODv2/TT_TuneCUETP8M1_13TeV-powheg-pythia8/MINIAODSIM/74X_mcRun2_asymptotic_v2_ext3-v1/10000/020B5100-426E-E511-888A-0026189437F9.root')
    ...
    fnames.append('/store/mc/RunIISpring15MiniAODv2/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/74X_mcRun2_asymptotic_v2-v1/60000/02CDE51A-726D-E511-B2C4-0025905C96EA.root')
  else:
...
MvaMetCollectionsTag = cms.VInputTag(),
...
# custom module producing 
process.packedPFCandidatesPuppi = cms.EDProducer("PuppiPFCandProducer",
                                                 pfCandidates = cms.InputTag("packedPFCandidates"))

process.load("RecoMET/METProducers.METSignificance_cfi")
process.load("RecoMET/METProducers.METSignificanceParams_cfi")
process.puppiMetSignificance = process.METSignificance.clone()
process.puppiMetSignificance.srcPfJets = cms.InputTag("slimmedJetsPuppi")
process.puppiMetSignificance.srcMet = cms.InputTag("slimmedMETsPuppi")
process.puppiMetSignificance.srcPFCandidates = cms.InputTag("packedPFCandidatesPuppi")
