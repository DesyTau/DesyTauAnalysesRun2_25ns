...
for i in {4..21}
do
    ./HTC_submit_seq.sh analysis_macro analysisMacro_ggH_2mu2tau_2018.conf SUSYGluGluToHToAA_AToMuMu_AToTauTau_M-${i} 5
done

echo submitting jobs for HToAA_To4Tau samples
for i in {4..21}
do
    ./HTC_submit_seq.sh analysis_macro analysisMacro_ggH_4tau_2018.conf SUSYGluGluToHToAA_AToTauTau_M-125_M-${i} 5
