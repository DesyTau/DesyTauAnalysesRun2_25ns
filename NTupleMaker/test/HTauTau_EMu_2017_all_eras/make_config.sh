...
sed 's/SampleNameForPUHist =/SampleNameForPUHist = ST_tW_antitop_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8_/' analysisMacroSynch_em_MC.conf > analysisMacroSynch_em_ST_tW_antitop_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8.conf
sed 's/SampleNameForPUHist =/SampleNameForPUHist = ST_tW_top_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8_/' analysisMacroSynch_em_MC.conf > analysisMacroSynch_em_ST_tW_top_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8.conf

sed 's/SampleNameForPUHist =/SampleNameForPUHist = TTTo2L2Nu_TuneCP5_PSweights_13TeV-powheg-pythia8_/' analysisMacroSynch_em_MC.conf > analysisMacroSynch_em_TTTo2L2Nu_TuneCP5_PSweights_13TeV-powheg-pythia8.conf
sed 's/SampleNameForPUHist =/SampleNameForPUHist = TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8_/' analysisMacroSynch_em_MC.conf > analysisMacroSynch_em_TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8.conf
sed 's/SampleNameForPUHist =/SampleNameForPUHist = TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_/' analysisMacroSynch_em_MC.conf > analysisMacroSynch_em_TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8.conf

sed 's/SampleNameForPUHist =/SampleNameForPUHist = W1JetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8_/' analysisMacroSynch_em_W.conf > analysisMacroSynch_em_W1JetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8.conf
sed 's/SampleNameForPUHist =/SampleNameForPUHist = W2JetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8_/' analysisMacroSynch_em_W.conf > analysisMacroSynch_em_W2JetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8.conf
...
sed 's/SampleNameForPUHist =/SampleNameForPUHist = WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8_/' analysisMacroSynch_em_W.conf > analysisMacroSynch_em_WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8.conf
...
sed 's/SampleNameForPUHist =/SampleNameForPUHist = EWKWMinus2Jets_WToLNu_M-50_TuneCP5_13TeV-madgraph-pythia8_/' analysisMacroSynch_em_W.conf > analysisMacroSynch_em_EWKWMinus.conf
sed 's/SampleNameForPUHist =/SampleNameForPUHist = EWKWPlus2Jets_WToLNu_M-50_TuneCP5_13TeV-madgraph-pythia8_/' analysisMacroSynch_em_W.conf > analysisMacroSynch_em_EWKWPlus.conf
sed 's/SampleNameForPUHist =/SampleNameForPUHist =  EWKZ2Jets_ZToLL_M-50_TuneCP5_13TeV-madgraph-pythia8_/' analysisMacroSynch_em_DY.conf > analysisMacroSynch_em_EWKZ2Jets_ZToLL.conf
sed 's/SampleNameForPUHist =/SampleNameForPUHist =  EWKZ2Jets_ZToNuNu_TuneCP5_13TeV-madgraph-pythia8_/' analysisMacroSynch_em_DY.conf > analysisMacroSynch_em_EWKZ2Jets_ZToNuNu.conf
