...
#include "TMath.h"
void Plot_lept_etau(TString Variable = "m_vis",
		     TString xtitle = "m_{vis} [GeV]",
		     int nBins  =   30,
		     float xmin =    0,
		     float xmax =  300,
		     TString Weight = "pu_weight*effweight*mcweight*",
		     TString Cuts = "&&iso_1<0.15&&extraelec_veto<0.5&&extramuon_veto<0.5&&pt_1>30&&pt_2>30&&mva_2>0.5&&againstMuonTight3_2>0.5&&againstElectronVLooseMVA6_2>0.5",//&&mva17_2>0.5&&mt_1<60&&(singleLepTrigger>0.5||xTrigger>0.5)
