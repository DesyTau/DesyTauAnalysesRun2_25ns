...
process.source = cms.Source("PoolSource",
		fileNames = cms.untracked.vstring('file:/nfs/dust/cms/user/alkaloge/ACD/NAFtools-RunOnProcessed/CMSSW_7_2_3/src/Submit/miniAOD/Output/WJetsToLNu_mlv_400toInf/WJetsToLNu_mlv_400toInf_tarball_run10161_unwgt_MiniAOD_chunk56.root')
	    # MINIAOD
# WJetsToLNu
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("/nfs/dust/cms/user/alkaloge/TauAnalysis/new/CMSSW_7_2_3_patch1/src/DesyTauAnalyses/NTupleMaker/test/WJets_NTuple/WJetsToLNu_mlv_400toInf_tarball_run10161_unwgt_MiniAOD_chunk56.root_NTuple.root")
                                   )
