...
void Plot_lept_etau_Updated(TString Variable = "m_vis",
			     TString xtitle = "m_{vis} [GeV]",
			     int nBins  =   30,
			     float xmin =    0,
			     float xmax =  300,
			     TString Weight = "puweight*effweight*mcweight*",
			     TString Cuts = "&&iso_1<0.15&&extraelec_veto<0.5&&byLooseIsolationMVArun2v1DBoldDMwLT_2>0.5&&dilepton_veto<0.5&&extramuon_veto<0.5&&pt_1>20&&pt_2>20&&mva17_2>0.5&&mt_1<60&&againstMuonLoose3_2>0.5&&againstElectronTightMVA6_2>0.5&&(singleLepTrigger>0.5||xTrigger>0.5)",//&&mva17_2>0.5&&mt_1<60
			     TString ytitle = "Events",
			     TString DataFile = "DATA_SingleElectron",
			     TString directory = "/nfs/dust/cms/user/cardinia/HtoTauTau/CMSSW_9_4_0_patch1/src/DesyTauAnalyses/NTupleMaker/test/etau/newNTuples/",
			     TString outputDir = "/nfs/dust/cms/user/cardinia/HtoTauTau/CMSSW_9_4_0_patch1/src/DesyTauAnalyses/NTupleMaker/test/Plots/",
