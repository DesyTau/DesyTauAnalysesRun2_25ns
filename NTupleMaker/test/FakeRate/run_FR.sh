...
./HTC_submit_seq.sh EleTauFR analysisMacro_etauFR_MC.conf DYJetsToLL_M-50_TuneCP5_13TeV_madgraphMLM_pythia8 20
./HTC_submit_seq.sh EleTauFR analysisMacro_etauFR_MC.conf DY1JetsToLL_M-50_TuneCP5_13TeV_madgraphMLM_pythia8 20
./HTC_submit_seq.sh EleTauFR analysisMacro_etauFR_MC.conf DY2JetsToLL_M-50_TuneCP5_13TeV_madgraphMLM_pythia8 20
./HTC_submit_seq.sh EleTauFR analysisMacro_etauFR_MC.conf DY3JetsToLL_M-50_TuneCP5_13TeV_madgraphMLM_pythia8 20
./HTC_submit_seq.sh EleTauFR analysisMacro_etauFR_MC.conf DY4JetsToLL_M-50_TuneCP5_13TeV_madgraphMLM_pythia8 20
./HTC_submit_seq.sh EleTauFR analysisMacro_etauFR_MC.conf TTTo2L2Nu_TuneCP5_13TeV_powheg_pythia8 20
./HTC_submit_seq.sh EleTauFR analysisMacro_etauFR_MC.conf TTToSemiLeptonic_TuneCP5_13TeV_powheg_pythia8 20
./HTC_submit_seq.sh EleTauFR analysisMacro_etauFR_MC.conf TTToHadronic_TuneCP5_13TeV_powheg_pythia8 20
