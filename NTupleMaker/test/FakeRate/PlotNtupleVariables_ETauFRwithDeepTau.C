...
{  
  ...
  TString tauTightIso = "taubyTightIsolationMVArun2v1DBoldDMwLT";
  TString againstMu = "tauagainstMuonLoose3";
  TString DeepTauString ="";

if(DeepTau>0.5){
  DeepTauString ="DeepTau";
  tauTightIso = "taubyTightDeepTau2017v2VSjet";
	...
	if(passProbe)
	  {
	    for (int i=0; i<nSamples; ++i)
	      {
		cuts[i] ="(tauagainstEle"+wp+DeepTauString+">0.5&&"+tauTightIso+">0.5&&"+againstMu+">0.5)*"+cuts[i];
		cutsSS[i] ="(tauagainstEle"+wp+DeepTauString+">0.5&&"+tauTightIso+">0.5&&"+againstMu+">0.5)*"+cutsSS[i];
	      }
	...
	else
	  {
	    for (int i=0; i<nSamples; ++i)
	      {
		cuts[i] ="(tauagainstEleLoose"+DeepTauString+"<0.5&&"+tauTightIso+">0.5)*"+cuts[i];
		cutsSS[i] ="(tauagainstEleLoose"+DeepTauString+"<0.5&&"+tauTightIso+">0.5)*"+cutsSS[i];
	      }
	  }
  ...
  // ********************************************
	...
	canv1->Print("./Plots/"+Variable+"_"+wp+DeepTauString+".png");
	canv1->Print("./Plots/"+Variable+"_"+wp+DeepTauString+".pdf","Portrait pdf");
