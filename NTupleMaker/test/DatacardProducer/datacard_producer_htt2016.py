...
lhtt = {"GluGluHTT_M125" : {"xsec": 2.9148, "isBinned": False, "binVar": "", "files": ["GluGluHToTauTau_M125"]}, 
"VBFHTT_M125" : {"xsec": 0.22692, "isBinned": False, "binVar": "", "files": ["VBFHToTauTau_M125"]},
"WmHTT_M125" : {"xsec": 0.0504, "isBinned": False, "binVar": "", "files": ["WminusHToTauTau_M125"]},
"WpHTT_M125" : {"xsec": 0.031968, "isBinned": False, "binVar": "", "files": ["WplusHToTauTau_M125"]},
"ZHTT_M125" : {"xsec": 0.053034, "isBinned": False, "binVar": "", "files": ["ZHToTauTau_M125"]}
}
...
for wkey, wvalue in weighting.iteritems():
	...
	for ckey, cvalue in cuts.iteritems():
		...
		for hkey, hvalue in histos.iteritems():
			...
			#print " Data OS: ", tdata.Draw(var+" >> hdata", cvalue + "&& q_1 * q_2 < 0.")
