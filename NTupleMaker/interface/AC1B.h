...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          track_count;
   Float_t         track_px[122];   //[track_count]
   Float_t         track_py[122];   //[track_count]
   Float_t         track_pz[122];   //[track_count]
   Float_t         track_pt[122];   //[track_count]
   Float_t         track_eta[122];   //[track_count]
   Float_t         track_phi[122];   //[track_count]
   Float_t         track_charge[122];   //[track_count]
   Float_t         track_mass[122];   //[track_count]
   Float_t         track_dxy[122];   //[track_count]
   Float_t         track_dxyerr[122];   //[track_count]
   Float_t         track_dz[122];   //[track_count]
   Float_t         track_dzerr[122];   //[track_count]
   Float_t         track_vx[122];   //[track_count]
   Float_t         track_vy[122];   //[track_count]
   Float_t         track_vz[122];   //[track_count]
   Int_t           track_ID[122];   //[track_count]
   Bool_t          track_highPurity[122];   //[track_count]
   Float_t         pfmet_ex;
   Float_t         pfmet_ey;
   Float_t         pfmet_ez;
   Float_t         pfmet_pt;
   ...
   Float_t         trigobject_px[200];   //[trigobject_count]
   Float_t         trigobject_py[200];   //[trigobject_count]
   Float_t         trigobject_pz[200];   //[trigobject_count]
   Float_t         trigobject_pt[200];   //[trigobject_count]
   Float_t         trigobject_eta[200];   //[trigobject_count]
   Float_t         trigobject_phi[200];   //[trigobject_count]
   Bool_t          trigobject_filters[200][200];   //[trigobject_count]
   Bool_t          trigobject_isMuon[200];   //[trigobject_count]
   Bool_t          trigobject_isElectron[200];   //[trigobject_count]
   Bool_t          trigobject_isTau[200];   //[trigobject_count]
   Bool_t          trigobject_isJet[200];   //[trigobject_count]
   Bool_t          trigobject_isMET[200];   //[trigobject_count]
