...
protected:
  virtual void InitSF(){
    ...
    sf_up->SetBinContent( sf_up->FindBin( pt_central[0], eta_central[0] ), central+error);
    sf_down->SetBinContent( sf_down->FindBin( pt_central[0], eta_central[0] ), central+error);
  };
