...
//
	...
	trig_weight = (trigWeightDataA * LumiA)/Lumi + 0.953 * (trigWeightDataB * LumiB)/Lumi;
	trig_weight_1 = (trigWeightDataA * LumiA)/Lumi ;
	trig_weight_2 =  (trigWeightDataB * LumiB)/Lumi;
	weight *= trig_weight;
