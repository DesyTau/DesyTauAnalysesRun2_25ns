...
struct find_element
{
    ...
    int lumi;
    int eventrn;
    find_element(int run,int lumi,int eventrn) : run(run),lumi(lumi),eventrn(eventrn) {}
    bool operator () ( const int& a , const int &b, const int &c) 
    { 
        return run==a.run && lumi==b.lumi && eventrn == c.eventrn
    }
};
*/
...
int main(int argc, char * argv[]) {
  ...
  TH1D * ZMassEtaPtPass[2][6];
  TH1D * ZMassEtaPtFail[2][6];

  TH1D * ZMassMu23EtaPtPass[2][7];
  TH1D * ZMassMu23EtaPtFail[2][7];

  TH1D * ZMassMu8EtaPtPass[2][7];
  TH1D * ZMassMu8EtaPtFail[2][7];
  ...
  for (int iEta=0; iEta<nEtaBins; ++iEta) {
    ...
    for (int iPt=0; iPt<nPtBinsTrig; ++iPt) {
      ZMassMu23EtaPtPass[iEta][iPt] = new TH1D("ZMassMu23"+EtaBins[iEta]+PtBinsTrig[iPt]+"Pass","",60,60,120);
      ZMassMu23EtaPtFail[iEta][iPt] = new TH1D("ZMassMu23"+EtaBins[iEta]+PtBinsTrig[iPt]+"Fail","",60,60,120);
      ZMassMu8EtaPtPass[iEta][iPt] = new TH1D("ZMassMu8"+EtaBins[iEta]+PtBinsTrig[iPt]+"Pass","",60,60,120);
      ZMassMu8EtaPtFail[iEta][iPt] = new TH1D("ZMassMu8"+EtaBins[iEta]+PtBinsTrig[iPt]+"Fail","",60,60,120);
    }
  }

  TH1D * ZMassMu23BarrelPass = new TH1D("ZMassMu23BarrelPass","",60,60,120);
  TH1D * ZMassMu23BarrelFail = new TH1D("ZMassMu23BarrelFail","",60,60,120);
  TH1D * ZMassMu23EndcapPass = new TH1D("ZMassMu23EndcapPass","",60,60,120);
  TH1D * ZMassMu23EndcapFail = new TH1D("ZMassMu23EndcapFail","",60,60,120);

  TH1D * ZMassMu8BarrelPass  = new TH1D("ZMassMu8BarrelPass", "",60,60,120);
  TH1D * ZMassMu8BarrelFail  = new TH1D("ZMassMu8BarrelFail", "",60,60,120);
  TH1D * ZMassMu8EndcapPass  = new TH1D("ZMassMu8EndcapPass", "",60,60,120);
  TH1D * ZMassMu8EndcapFail  = new TH1D("ZMassMu8EndcapFail", "",60,60,120);
