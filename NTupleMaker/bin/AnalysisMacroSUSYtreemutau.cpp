...
// Lepton Scale Factors 
  ...
  if (applyTFR) {
    ...
    SF_TFR->init_ScaleFactor(TString(cmsswBase)+"/src/"+TString(TauFakeRateFile),applyTFR);
  }
  ...
  tree->Branch("qcddzetaweight", &qcddzetaweight, "qcddzetaweight/F");
