...
//    Edited by Andrea Cardini (andrea.cardini@desy.de) for 2018 MC
//
...
int main(int argc, char * argv[]){
  ...
  // second argument - optional index of the first file to be analyzed
  ...
  const string infiles = argv[1];
  const string sample = argv[1];
